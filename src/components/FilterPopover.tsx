    ...
    return (
        <div className="relative" ref={popoverRef}>
            ...
            >
                ...
                {activeFilterCount > 0 && (
                    <span className="bg-blue-500 text-on-accent text-xs px-1.5 py-0.5 rounded-full">{activeFilterCount}</span>
                )}
            </button>
                                ...
                                <div className="flex flex-wrap gap-2 mb-3">
                                    ...
                                    {options.categories?.map(cat => (
                                        <button
                                            ...
                                            className="px-3 py-1.5 rounded-full text-sm font-medium bg-blue-600 text-on-accent shadow-lg flex items-center gap-1"
                                        >
                                            #{cat}
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                <line x1="18" y1="6" x2="6" y2="18"></line>
