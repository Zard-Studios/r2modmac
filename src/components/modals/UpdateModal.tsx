            ...
            >
                ...
                <div className="flex-shrink-0 p-4 border-t border-gray-700 bg-gray-900/50 rounded-b-xl flex justify-end gap-2">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-green-600 hover:bg-green-500 text-on-success rounded-lg text-sm font-semibold transition-all flex items-center gap-1.5 disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed"
                    >
