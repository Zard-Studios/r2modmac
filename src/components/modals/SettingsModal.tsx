                    ...
                    <div className="flex items-stretch gap-0.5 flex-shrink-0">
                        <button
                            ...
                            className={`px-3 text-sm font-medium whitespace-nowrap transition-colors flex items-center gap-1.5 border-b-2 relative ${
                                activeTab === 'settings'
                                    ? 'border-blue-500 text-fg-accent'
                                ...
                                <div className="mb-6">
                                    ...
                                    {checkingGamePath ? (
                                        ...
                                        <div className="space-y-3">
                                            <div className="flex items-start gap-2 text-xs text-fg-warning bg-yellow-900/20 border border-yellow-500/30 rounded-lg p-3">
