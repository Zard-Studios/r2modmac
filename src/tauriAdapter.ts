...
export const tauriAPI: IElectronAPI = {
    ...
    requestSponsor: async () => invoke('request_sponsor'),
    ...
    updateSponsorPreferences: async (enabled, lessFrequently) => invoke('update_sponsor_preferences', { enabled, lessFrequently }),
