...
#[command]
pub async fn export_profile(app: AppHandle, profile_id: String) -> Result<serde_json::Value, String> {
...
#[command]
pub async fn import_profile_from_file(_app: AppHandle, path: String) -> Result<serde_json::Value, String> {
