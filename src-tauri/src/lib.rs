...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::legacy_system_commands::fetch_communities,
            commands::legacy_system_commands::fetch_community_images,
            commands::legacy_system_commands::fetch_text_content,
            commands::legacy_system_commands::resolve_community_platforms,
            commands::legacy_system_commands::confirm_dialog,
            commands::legacy_system_commands::alert_dialog,
            commands::legacy_system_commands::select_folder,
            commands::legacy_system_commands::get_username,
            ...
            commands::game_commands::apply_transaction::commit_profile_apply_transaction,
            ...
            commands::mod_commands::cancel_mod_operations,
            commands::mod_commands::mod_operations_cancelled,
            commands::legacy_mod_commands::inspect_custom_mod,
            commands::legacy_mod_commands::cancel_custom_mod_import,
            commands::legacy_mod_commands::import_custom_mod,
            commands::legacy_mod_commands::refresh_local_mod_metadata,
            commands::legacy_mod_commands::import_embedded_custom_mod,
            commands::legacy_mod_commands::install_local_mod,
            commands::legacy_mod_commands::delete_local_mod_payload,
            commands::legacy_mod_commands::open_mod_folder,
            commands::legacy_mod_commands::remove_mod,
            commands::legacy_mod_commands::toggle_mod,
            ...
            commands::export_import::import_profile_configs,
